...
export const routes = [
  ...
  {
    id: "week03-transforms",
    kind: "activity",
    week: 3,
    title: "Transformations & Viewing",
    path: "/activities/week03-transforms",
    summary:
      "A cube driven by model, view, and projection matrices, combined into one MVP uniform.",
    Component: lazy(() => import("@/activities/week03-transforms/index.jsx")),
  },
  {
    id: "a1-primitives",
    kind: "assignment",
  ...
  },
  {
    ...
    path: "/activities/week05-shading",
    summary: "Unlit, Gouraud, and per-fragment shading compared side by side on the same mesh.",
    Component: lazy(() => import("@/activities/week05-shading/index.jsx")),
  },
  {
  ...
  },
  {
    ...
    kind: "activity",
    week: 8,
    title: "Meshes & Data Structures",
    path: "/activities/week08-meshes",
    summary: "One indexed mesh, drawn solid or as a wireframe built from its unique edges.",
    Component: lazy(() => import("@/activities/week08-meshes/index.jsx")),
  },
  {
  ...
  },
  {
    ...
    week: 11,
    title: "Sampling",
    path: "/activities/week11-sampling",
    summary: "Monte Carlo estimation of pi as a growing WebGPU point cloud.",
    Component: lazy(() => import("@/activities/week11-sampling/index.jsx")),
  },
  {
    id: "a6-raytracer",
    kind: "assignment",
  ...
  },
  {
    ...
    path: "/activities/week13-pbr",
    summary: "A Cook-Torrance BRDF sphere with roughness/metallic controls and an orbiting light.",
    Component: lazy(() => import("@/activities/week13-pbr/index.jsx")),
  },
  {
    id: "a7-final-project",
    kind: "assignment",
